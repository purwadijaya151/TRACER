...
alter table public.alumni add column if not exists npp varchar(30);

comment on column public.alumni.nim is 'NPM mahasiswa/alumni. Untuk row admin legacy, isi kode staff internal, bukan NPP.';
comment on column public.alumni.npp is 'NPP staff/admin kampus. Mahasiswa/alumni tidak memakai kolom ini.';
